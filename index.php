...
<div class="container"><br>
    ...
    <h1 class="text-center">Plataforma de Información de Estudiantes</h1><br>
        ...
        <div class="col-md-4 offset-md-4">
            <form method="POST">
                <table class="text-center infotable">
                    ...
                    <tr>
                        <td>
                            <p><label for="roll">ID Estudiante</label></p>
                        </td>
                        <td>
                            <input class="form-control" type="text" id="roll" placeholder="6 dígitos..." name="roll">
                        </td>
                    </tr>
                    <tr>
    ...
    if (isset($_POST['showinfo'])) {
        ...
        if (!empty($choose && $roll)) {
            $query = mysqli_query($db_con, "SELECT * FROM `student_info` WHERE `roll`='$roll' AND `semestre`='$choose'");
            if (!empty($row = mysqli_fetch_array($query))) {
                if ($row['roll'] == $roll && $choose == $row['semestre']) {
                    $stroll = $row['roll'];
                    $stname = $row['name'];
                    $stsemestre = $row['semestre'];
                    $carrera = $row['carrera'];
                    $photo = $row['photo'];
                    ...
                    <div class="row">
                        <div class="col-sm-6 offset-sm-3">
                            <table class="table table-bordered">
                                <tr>
                                    <td rowspan="5">
                                        ...
                                        <img class="img-thumbnail"
                                             src="admin/images/<?= isset($photo) ? $photo : ''; ?>" width="250px">
                                    </td>
                                ...
                                <tr>
                                    <td>Semestre</td>
                                    <td><?= isset($stsemestre) ? $stsemestre : ''; ?></td>
                                </tr>
                                <tr>
                                    <td>Carrera</td>
                                    <td><?= isset($carrera) ? $carrera : ''; ?></td>
                                </tr>
                                <tr>
                                    <td>Celular</td>
                ...
                <?php
                    ...
                    echo '<p style="color:red;">Por favor ingrese un ID Estudiante y/o semestre válidos</p>';
                }
            } else {
                echo '<p style="color:red;">Sus credenciales no coinciden</p>';
            }
        } else {
            ?>
