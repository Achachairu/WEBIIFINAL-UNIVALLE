...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li class="nav-item"><a class="nav-link" href="index.php?page=add-student"><i class="fa fa-user-plus"></i> Registrar Estudiante</a></li>
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="list-group">
        ...
        <a href="index.php?page=add-student" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Registrar Estudiante</a>
